...
public class UserController {
    ...
    public ResponseEntity<ArrayList<UserDTO>> addFriend(@PathVariable("user_id") Long user_id,
    ...
    public ResponseEntity<ArrayList<UserDTO>> deleteFriend(@PathVariable("user_id") Long user_id,
                                                           @PathVariable("friend_id") Long friend_id)
            throws UserExceptions {
    ...
    public ResponseEntity<List<Long>> getUserFriends(@PathVariable Long userid)
            throws UserExceptions {

...
public class AccountController {
    ...
    public ResponseEntity<AccountDTO> withdraw(@PathVariable("accountId") Long accountId,
    ...
    public ResponseEntity<AccountDTO> getBalance(@PathVariable("accountId") Long accountId)
    ...
    public ResponseEntity<List<TransactionDTO>> getAllTransactionsByType(@PathVariable("type") TransactionTypes
                                                                                 transactionTypes)
            throws AccountExceptions {
    ...
    public ResponseEntity<List<TransactionDTO>> getAllTransactionsByIdAndType(@PathVariable("account_id") Long accountId,
                                                                              @PathVariable("type") TransactionTypes
                                                                                      transactionTypes)
            throws AccountExceptions {
